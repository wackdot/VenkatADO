...
namespace AdoDemo {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentsRow AddStudentsRow(string Name, string Gender, int TotalMarks) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public int TotalMarks {
                get {
                    return ((int)(this[this.tableStudents.TotalMarksColumn]));
                }
                set {
...
namespace AdoDemo.StudentDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Name], [Gender], [TotalMarks]) VALUES (@Name, @Gen" +
                "der, @TotalMarks)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Students] SET [Name] = @Name, [Gender] = @Gender, [TotalMarks] = @T" +
                "otalMarks WHERE (([Id] = @Original_Id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AdoDemo.Properties.Settings.Default.ADOConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Gender, TotalMarks FROM dbo.Students";
        ...
        public virtual int Insert(string Name, string Gender, int TotalMarks) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Gender, int TotalMarks, int Original_Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
